#  Timedoctor Sample App


## Install

```bash
git clone https://github.com/nishants/timedoctor.git
```
...
1. `./package.json` in the root of project
...
Credits for boilerplate : https://github.com/chentsulin/electron-react-boilerplate
