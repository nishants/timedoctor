...
export default class MenuBuilder {
  ...
  buildDarwinTemplate() {
    const subMenuAbout = {
      label: 'Electron',
      submenu: [
        { label: 'About TimeDoctor', selector: 'orderFrontStandardAboutPanel:' },
        { type: 'separator' },
        { label: 'Services', submenu: [] },
        { type: 'separator' },
        { label: 'Hide TimeDoctor', accelerator: 'Command+H', selector: 'hide:' },
    ...
    const subMenuViewDev = {
      label: 'View',
      submenu: [
        { label: 'Toggle widget', accelerator: 'Command+W', click: () => { this.toggleWidget(); } },
